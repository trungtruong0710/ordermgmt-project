...
test.describe('Create one-time fee order without tax and discount', () => {
    ...
    test('Create order with 1 one-time fee', async () => {
    ...
    test('Create order with multiples one-time fees', async () => {
        ...
        await createOrder.assertSubTotal200();
        await createOrder.assertTotal200();
