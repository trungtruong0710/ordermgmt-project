...
test.describe('Create one-time fee order with inclusive tax', () => {
    ...
    test('Create order with 1 one-time fee with inclusive tax', async () => {
    ...
    test('Create order with 3 one-time fees with different inclusive tax', async () => {
        await login.adminSignIn();
        await student.searchStudentName();
        await student.selectStudent();
        await createOrder.selectCreateOrder();
