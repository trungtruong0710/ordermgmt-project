...
test.describe('Create one-time fee order with multiple one-time fees and discount', () => {
    ...
    test('Create order with 2 one-time fees and discount by fixed amount for both', async () => {
        ...
        await createOrder.selectDropDownList();
        await createOrder.clickAddNewProduct();
        await createOrder.select2Fee100NoTaxArray1();
        await createOrder.selectDropDownList();
        ...
        await createOrder.assertFeeNameAndPriceFee100NoTaxArray0();
        await createOrder.assertFee2NameAndPriceFee100NoTaxArray1();
    ...
    test('Create order with 2 one-time fees and discount by percent for both', async () => {
        await login.adminSignIn();
        await student.searchStudentName();
        await student.selectStudent();
        await createOrder.selectCreateOrder();
    ...
    test('Create order with 2 one-time fees and discount by percent and fixed amount', async () => {
        await login.adminSignIn();
        await student.searchStudentName();
        await student.selectStudent();
        await createOrder.selectCreateOrder();
    ...
    test('Create order with 2 one-time fees and only discount by percent for one', async () => {
        await login.adminSignIn();
        await student.searchStudentName();
        await student.selectStudent();
        await createOrder.selectCreateOrder();
    ...
    test('Create order with 2 one-time fees and only discount by fixed amount for one', async () => {
        await login.adminSignIn();
        await student.searchStudentName();
        await student.selectStudent();
        await createOrder.selectCreateOrder();
