...
test.describe('Create one-time material order with inclusive tax and discount', () => {
    ...
    test('Create order with 1 one-time material with discount by fixed amount and inclusive tax', async () => {
    ...
    test('Create order with 1 one-time material with discount by percent and inclusive tax', async () => {
        await login.adminSignIn();
        await student.searchStudentName();
        await student.selectStudent();
        await createOrder.selectCreateOrder();
    ...
    test('Create order with 3 one-time materials with different discount and different inclusive tax', async () => {
